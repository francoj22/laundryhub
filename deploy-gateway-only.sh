#!/bin/bash
# Quick deployment script for gateway only (fastest option)

set -e

echo "🚀 Deploying gateway only to production..."
...
# Deploy
echo "🔄 Pulling latest code and restarting gateway..."
...
echo ""
echo "📊 Gateway status:"
docker-compose --env-file .env.aws ps gateway
ENDSSH
